...
public class Controller {
    ...
    public void countTime() {// count the time
    ...
    public void addButton() {
        ...
        g.getPnScreen().setPreferredSize(new Dimension(sizeOfMatrix * 60 + 10 * (sizeOfMatrix - 1),
                sizeOfMatrix * 60 + 10 * (sizeOfMatrix - 1)));
    ...
    public void newGame() {
        if (isGameStarted) {
            timer.stop();
            int confirm = JOptionPane.showConfirmDialog(null, "Do you" + " want to make a new game?", "New Game",
